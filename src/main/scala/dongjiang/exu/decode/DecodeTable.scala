...
object LoaclAtomicDecode {
  def atomicX: Seq[(UInt, UInt)] = Seq(
    ...
    LocalReqInst(AtomicLoadADD,  I,  I, SC, HasData) -> (ReadDCU   | ReadOp(ReadNoSnp) | Resp(ChiResp.SC)),
    LocalReqInst(AtomicLoadADD,  I,  I, SD, HasData) -> (ReadDCU   | ReadOp(ReadNoSnp) | Resp(ChiResp.SD)),
    LocalReqInst(AtomicLoadADD,  I,  I, UC, HasData) -> (ReadDCU   | ReadOp(ReadNoSnp) | Resp(ChiResp.UC)),
    LocalReqInst(AtomicLoadADD,  I,  I, UD, HasData) -> (ReadDCU   | ReadOp(ReadNoSnp) | Resp(ChiResp.UC_PD)),
